...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/26 21:36:46 by fgabri            #+#    #+#             */
/*   Updated: 2022/09/26 22:19:59 by fgabri           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_word(char *str, char *charset)
{
	...
	i = 0;
	len_word = ft_len_sep(str, charset);
...
char	**ft_split(char *str, char *charset)
{
	...
	i = 0;
	strings = malloc(sizeof(char *) * (total_strings(str, charset) + 1));
	while (*str != '\0')
	{
